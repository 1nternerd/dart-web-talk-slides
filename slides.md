...
# Dart Web: The Good, the Bad and the Wupper
...
- it actually compiles to Javascript
  ...
  - _(but there is still some magic going on with Future !== Promise, ...)_
- You can access the DOM via `dart:html`
...
# How do I build a Dart Web app?

TODO
  - Create dart web project
  - create main dart
  - install build_runner build_web_compilers
